...
def main():
    ...
    proxy_url = "http://45.89.228.139:8888"
    
    print(f"--- Тестирование роутинга прокси с основного VPS {hostname}... ---")
    ...
    try:
        ...
        # Test routing through Russian VPS proxy
        print(f"Выполнение запроса через прокси {proxy_url}...")
        ...
        if not output:
            print("[WARN] Нет ответа от прокси.")
        ...
        try:
            ...
            print(f"\n[SUCCESS] Прокси успешно работает! Маршрутизация проверена.")
